...
bpy.data.objects['Title'].data.body = "Bratwurst Stats of 12, 2016" 
...
bpy.data.objects['TimeTaken'].data.body = "generated in " + str(round(time.time() * 1000) - 1485899364121) +  "ms";